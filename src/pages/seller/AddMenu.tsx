...
const AddMenu: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const token = localStorage.getItem('token');
      const res = await fetch('http://localhost:5118/api/menus', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
        ...
        body: JSON.stringify({
          ...
          imageUrl: imageUrl, // chỉ gửi URL, không gửi base64
      ...
      if (res.ok) {
        ...
        setError(data.message || 'Thêm món ăn thất bại!');
      }
    } catch (err: any) {
      setError(err.message || 'Đã xảy ra lỗi');
    } finally {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-6 sm:p-8">
              <h1 className="text-2xl font-bold text-gray-800 mb-6">Thêm món ăn mới</h1>
